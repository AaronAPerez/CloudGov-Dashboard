...
//  * API Configuration
//  */
// const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://cloudgov-dashboard.vercel.app/api';
...
//   // Mock toast function
//   const showToast = useCallback((_params: { type: string; message: string }) => {
