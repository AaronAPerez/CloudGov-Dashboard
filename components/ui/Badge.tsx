...
const variantStyles: Record<BadgeVariant, string> = {
  success: 'bg-success-100 text-success-800 border-success-200 dark:bg-success-950 dark:text-success-200 dark:border-success-800',
  warning: 'bg-warning-100 text-warning-800 border-warning-200 dark:bg-warning-950 dark:text-warning-200 dark:border-warning-800',
  error: 'bg-error-100 text-error-800 border-error-200 dark:bg-error-950 dark:text-error-200 dark:border-error-800',
  info: 'bg-primary-100 text-primary-800 border-primary-200 dark:bg-primary-950 dark:text-primary-200 dark:border-primary-800',
